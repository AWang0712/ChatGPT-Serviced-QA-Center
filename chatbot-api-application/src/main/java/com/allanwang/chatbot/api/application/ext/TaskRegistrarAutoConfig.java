package com.allanwang.chatbot.api.application.ext;

import com.allanwang.chatbot.api.application.job.ChatbotTask;
import com.allanwang.chatbot.api.common.PropertyUtil;
...
public class TaskRegistrarAutoConfig implements EnvironmentAware, SchedulingConfigurer {
    ...
    public void configureTasks(ScheduledTaskRegistrar taskRegistrar) {
        ...
        for (String groupKey : taskGroups) {
            ...
            logger.info("add task: groupName：{} groupId：{} cronExpression：{}", groupName, groupId, cronExpression);
            // addCronTask
