package com.allanwang.chatbot.api.domain.zsxq.service;
...
import com.allanwang.chatbot.api.domain.zsxq.model.req.AnswerReq;
import com.allanwang.chatbot.api.domain.zsxq.model.req.ReqData;
import com.allanwang.chatbot.api.domain.zsxq.model.res.AnswerRes;
...
public class ZsxqApi implements IZsxqApi {
    ...
    public UnAnsweredQuestionsAggregates queryUnAnsweredQuestionsTopicId(String groupId, String cookie) throws IOException {
        ...
        if (response.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
            ...
            logger.info("Pull query data. groupId：{} jsonStr：{}", groupId, jsonStr);
            //transfer json
